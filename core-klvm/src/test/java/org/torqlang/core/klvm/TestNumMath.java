...
public class TestNumMath {
    ...
    private static BigDecimal bigDecimal(char c) {
        return new BigDecimal(c, DECIMAL128);
    }
    ...
    private static BigDecimal bigDecimal(long l) {
    ...
    public void testAdd() {
        ...
        assertTrue(sum instanceof Int32);
        ...
        assertTrue(sum instanceof Int64);
        ...
        assertTrue(sum instanceof Dec128);
        ...
        assertTrue(sum instanceof Dec128);
        assertEquals(bigDecimal(5d).add(bigDecimal(3), DECIMAL128), sum.decimal128Value());
    }
    ...
    public void testDivide() {
        ...
        assertTrue(quotient instanceof Int32);
        ...
        assertTrue(quotient instanceof Int64);
        ...
        assertTrue(quotient instanceof Dec128);
        ...
        assertTrue(quotient instanceof Dec128);
        assertEquals(bigDecimal(5d).divide(bigDecimal(3), DECIMAL128), quotient.decimal128Value());
    }
    ...
    public void testModulo() {
        ...
        assertTrue(quotient instanceof Dec128);
        assertEquals(bigDecimal(5d).remainder(bigDecimal(3), DECIMAL128), quotient.decimal128Value());
    }
    ...
    public void testMultiply() {
        ...
        assertTrue(product instanceof Int32);
        ...
        assertTrue(product instanceof Int64);
        ...
        assertTrue(product instanceof Dec128);
        ...
        assertTrue(product instanceof Dec128);
        assertEquals(bigDecimal(5d).multiply(bigDecimal(3), DECIMAL128), product.decimal128Value());
    }
    ...
    public void testSubtract() {
        ...
        assertTrue(diff instanceof Int32);
        ...
        assertTrue(diff instanceof Int64);
        ...
        assertTrue(diff instanceof Dec128);
        ...
        assertTrue(diff instanceof Dec128);
        assertEquals(bigDecimal(5d).subtract(bigDecimal(3), DECIMAL128), diff.decimal128Value());
    }
