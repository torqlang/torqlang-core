...
public final class CreateProcStmt extends AbstractCreateProcStmt {

    public CreateProcStmt(Ident x, ProcDef procDef, SourceSpan sourceSpan) {
    ...
    public final <T, R> R accept(KernelVisitor<T, R> visitor, T state)
        throws Exception
    {
        return visitor.visitCreateProcStmt(this, state);
    }
