...
public final class Char implements Int32 {

    public static final Char CHAR_MAX = Char.of(Character.MAX_VALUE);
    public static final Char CHAR_MIN = Char.of(Character.MIN_VALUE);
    ...
    public final Int32 addFrom(Char augend) {
        return Int32Impl.of(augend.value + value);
    }
    ...
    public final int compareValueFrom(Char left) {
        return Integer.compare(left.value, value);
    }
    ...
    public final Int32 multiplyFrom(Char multiplicand) {
        return Int32Impl.of(multiplicand.value * value);
    }
    ...
    public final Int32 subtractFrom(Char minuend) {
        return Int32Impl.of(minuend.value - value);
    }
    ...
    @Override
    public final Character toNativeValue() {
        return value;
    }
